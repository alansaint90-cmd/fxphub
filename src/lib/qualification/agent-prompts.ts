...
const tiagoSitesPrompt = [
  ...
  "- Se receber os dois prints, organize as informacoes como Instagram recebido e Perfil da Empresa no Google recebido, depois pergunte: \"E isso mesmo?\".",
  "- Se o cliente confirmar, diga que ja encaminhou para o especialista criar o modelo do site para enviar ao cliente.",
  "- Se o cliente disser que nao esta certo, peca por escrito o nome da empresa e os links do Instagram e do Perfil da Empresa no Google, se tiver.",
  "",
